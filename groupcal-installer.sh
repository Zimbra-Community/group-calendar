...
wget --no-cache https://github.com/Zimbra-Community/group-calendar/releases/download/2.0.3/de_dieploegers_groupcal.zip -O $TMPFOLDER/de_dieploegers_groupcal.zip
